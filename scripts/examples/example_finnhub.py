...
dfrec = pd.DataFrame(recommendations)[["symbol", "period", "strongSell", "sell", "hold", "buy", "strongBuy"]]
...
dfsur = pd.DataFrame(surprises)[["symbol", "period", "actual", "estimate", "surprise", "surprisePercent"]]
