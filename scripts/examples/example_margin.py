...
def calculate_target_price(entry_price, original_amount, borrowed_amount, desired_roe, position_type):
...
target_price_wom = (
    (1 + desired_roe / 100) * entry_price if position_type == "long" else (1 - desired_roe / 100) * entry_price
)
print(f"The target price to exit the {position_type} bet for {desired_roe}% ROE w/o Leverage: {target_price_wom:.2f}")

target_price = calculate_target_price(entry_price, original_amount, borrowed_amount, desired_roe, position_type)
print(f"The target price to exit the {position_type} bet for {desired_roe}% ROE: {target_price:.2f}")
